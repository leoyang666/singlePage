...
<body>
    ...
    <div class="hero-body">
      <div class="container">
        ...
        <div class="columns has-text-centered">
          <div class="column">
            <h1 class="title is-1">Mark Macneil</h1>
            <h2 class="subtitle">FullStack .NET Dev, Halifax, NS</h2>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="media">
            ...
            <div class="media-content">
              ...
              <p class="subtitle is-6">
                Title -
                <time datetime="2018-1">January 2018</time> -
        ...
        <div class="card-content">
          <div class="media">
            ...
            <div class="media-content">
              ...
              <p class="subtitle is-6">
                Title -
                <time datetime="2018-1">August 2017</time> -
                <time datetime="2017-9">January 2018</time>
              </p>
            </div>
          </div>
          <div class="content">
            ...
            <div class="tile is-parent is-vertical">
              <article class="tile is-child notification">
                ...
                <figure class="image is-4by3">
                  <img
                    class="modal-trigger"
                    data-target="project-1-modal"
                    src="img/project-1-cover.png"
                  />
                </figure>
              </article>
            </div>
            <div class="tile is-parent">
              <article class="tile is-child notification">
                ...
                <figure class="image is-4by3">
                  <img
                    class="modal-trigger"
                    data-target="project-2-modal"
                    src="img/project-2-cover.png"
                  />
                </figure>
              </article>
            </div>
            <div class="tile is-parent">
              <article class="tile is-child notification">
                ...
                <figure class="image is-4by3">
                  <img
                    class="modal-trigger"
                    data-target="project-3-modal"
                    src="img/project-3-cover.png"
                  />
                </figure>
              </article>
            </div>
            ...
            <div class="tile is-parent is-vertical">
              <article class="tile is-child notification">
                ...
                <figure class="image is-4by3">
                  <img
                    class="modal-trigger"
                    data-target="project-4-modal"
                    src="img/project-4-cover.png"
                  />
                </figure>
              </article>
            </div>
            <div class="tile is-parent">
              <article class="tile is-child notification">
                ...
                <figure class="image is-4by3">
                  <img
                    class="modal-trigger"
                    data-target="project-5-modal"
                    src="img/project-5-cover.png"
                  />
                </figure>
              </article>
            </div>
            <div class="tile is-parent">
              <article class="tile is-child notification">
                ...
                <figure class="image is-4by3">
                  <img
                    class="modal-trigger"
                    data-target="project-6-modal"
                    src="img/project-6-cover.png"
                  />
                </figure>
              </article>
            </div>
      ...
      <div class="card card-gap">
        <div class="card-content">
          <div class="content">
            ...
            <p class="subtitle is-6">
              Program/Course -
              <time datetime="2015-9">September 2014</time> -
              <time datetime="2015-9">Sepemter 2015</time>
            </p>
          </div>
          <div class="content">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
      ...
      <nav class="level">
        <div class="level-item has-text-centered">
          <div>
            ...
            <p class="heading">
              <a href="https://github.com/mmacneil">github.com/mmacneil</a>
            </p>
          </div>
        </div>
        <div class="level-item has-text-centered">
          <div>
            ...
            <p class="heading">
              <a href="https://fullstackmark.com">fullstackmark.com</a>
            </p>
          </div>
        </div>
        <div class="level-item has-text-centered">
          <div>
            ...
            <p class="heading">
              <a href="mailto:markmacneil@gmail.com">markmacneil@gmail.com</a>
            </p>
          </div>
        </div>
        <div class="level-item has-text-centered">
          <div>
            ...
            <p class="heading">
              <a href="https://www.linkedin.com/in/markmacneilhfx">linkedin</a>
            </p>
          </div>
        </div>
      </nav>
  ...
  <footer class="footer">
    <div class="content has-text-centered">
      <p>
        <a
          href="https://github.com/mmacneil/devfolio"
          target="_blank"
